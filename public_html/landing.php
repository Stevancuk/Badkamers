...
<body>
	...
	<div class="backGroundImages">
		<img src="images/girl_with_a_book.jpg">
		<div class="overLayerOpacity backColBlackOpacity">
			<h1 class="mx-auto colWhite mt-5 mb-4 pt-5">About Us</h1>
			<h3 class="mx-auto colWhite h3Main text-center">Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text
			Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text Text text text</h3>
		</div>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	  	...
	  	<div class="carousel-inner">
	  		<div class="backColBlack sliderTextAndComment w-100">
	  			<div class="vertically-align-mid w-75 mx-auto py-3">
	    	...
	    	<div class="carousel-item active">
	      		<div class="caruselInnerMain vertically-align-mid backColBlack">
	      			<div class="colBlack backColCream caruselInnerSub mx-auto">
	      				<div class="vertically-align-mid mt-4  mx-5 mb-5 justify-content-between">
	      					<div class="imgDivCarousel borderYellow vertically-align-mid">
	      						<img src="">
	      					</div>
	      					<h2 class="colBlack">Anna and Bryan</h2>
	      					<div class="imgDivCarousel"></div>
	      				</div>
	      				<h3 class="text-left mx-5">Plannen voor badkamer renovatie? De specialisten van badinstallaties regelen alles voor u. Door creatieve badkamer ideeën en slimme oplossingen, realiseren we voor iedere badkamer een complete renovatie. Van ontwerp tot montage Uw volledige badkamer renoveren? Dat kan! Maar ook met kleine aanpassingen krijgt uw badkamer een volledig nieuwe look. Het team van badinstallaties regelt alles voor.</h3>
	      			</div>
	      		</div>
	    	</div>
	  	...
	  	<a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
	    	<i class="fas fa-chevron-left fa-5x colWhite" aria-hidden="true"></i>
	    	<span class="sr-only">Previous</span>
	  	</a>
	  	<a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
	    	<i class="fas fa-chevron-right fa-5x colWhite" aria-hidden="true"></i>
