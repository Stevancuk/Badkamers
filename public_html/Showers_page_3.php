...
<html lang="en">
<head>
<?php getMetaData('Showers Page 3', 'css-v*.css'); ?>
</head>
<body>
	...
	<div class="backGroundImages vertically-align-mid">
		<img src="images/Showers-(4-)-pages-header3.png">
	</div>
	<div class="mt-5">
		<h1 class="text-center mb-5">Douchecabine of douchewand voor een droge vloer</h1>
		<h3 class="mb-5 text-center h3Main mx-auto">Met een douchewand of badwand voorkom je dat je badkamervloer helemaal nat is na je verkwikkende douche- of badritueel. Je kunt bijvoorbeeld kiezen voor strakke, losse wanden waarmee je een riante  inloopdouche creëert. Of heb je liever een douchecabine? Deze heb je tegenwoordig in heerlijk ruime varianten en met luxe accessoires. Er zijn verschillende oplossingen om je badkamervloer droog te houden:</h3>
		<h1 class="text-center mb-5">Douchecabine</h1>
		<h3 class="mb-5 text-center h3Main mx-auto">In diverse afmetingen en vormen verkrijgbaar. Een douchecabine houdt niet alleen al het water binnen, maar ook de meeste warmte.</h3>
		<h1 class="text-center mb-5">Inloopdouche</h1>
		<h3 class="mb-5 text-center h3Main mx-auto">Een douche in een nis tussen twee muren of met een losse douchewand. De open zijde geeft je een gevoel van ruimte. Hoe hoog je wand wordt en welk materiaal je kiest, is helemaal aan jou! Hierdoor past deze optie in elke badkamer.</h3>
		<h1 class="text-center mb-5">Badwand</h1>
		...
		<div class="showersSection3 backgroundPar">
			<div class="backColBlackOpacity w-100 h-100">
		    	...
		    	<h1 class="colWhite">Soorten, maten en stijlen</h1>
		    	<h3 class="colWhite text-center h3Main mx-auto py-3">Douche- en badwanden zijn er van borst- tot plafondhoogte. Daarnaast heb je de keuze uit diverse materialen: transparant glas, kunststof, matglas of transparant glas met een werkje erin. Ga je voor schoonmaakgemak en zo neutraal mogelijk, dan neem je transparant glas. Getint glas kan ook. Douchecabines zijn er in allerlei maten en vormen: half rond, rond, vierkant en rechthoekig. Je kunt kiezen voor strak of juist gedecoreerd met matglas of een patroon op de ruitjes. Zeer bepalend bij je keuze is de beschikbare ruimte in je badkamer. Heb je een kleine badkamer en wil je voor de kinderen een bad en voor jezelf een douche? Een douche en een bad in één creëer je met een badwand of douche en bad in één. Een douchecabine is er voor elk formaat badkamer. Toch liever een inloopdouche? Kies dan de best passende variant. Een inloopdouche in een nis maakt een ruimte optisch kleiner. Een transparante douchewand houdt de ruimte open en licht maar biedt minder privacy.</h3>
		    </div>
		</div>
		<h1 class="text-center my-5">Douchewand gecombineerd met douchevloer</h1>
		<h3 class="mb-5 text-center h3Main mx-auto">Steeds meer mensen die voor een inloopdouche kiezen combineren een douchewand met een douchevloer in plaats van tegels. Dit heeft te maken met het onderhoudsgemak: doordat een douchevloer geen voegen heeft, is deze makkelijk schoon te houden. Douchevloeren zijn verkrijgbaar in allerlei kleuren, dus je vindt er zeker een die bij jouw tegels past. Soorten, maten en stijlen.</h3>
		<h3 class="mb-5 text-center h3Main mx-auto"><b>" Een douche en bad in één, handig en wat een luxe!</b></h3>
